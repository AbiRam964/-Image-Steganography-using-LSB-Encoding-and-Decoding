...
typedef struct _EncodeInfo
{
    ...
    FILE *fptr_src_image; //file address of beautiful.bmp file
    uint image_capacity; //store bmp file size
    uint bits_per_pixel;
    ...
    /* Stego Image Info */
    char *stego_image_fname; //output.bmp
    FILE *fptr_stego_image; //File address of output.bmp
